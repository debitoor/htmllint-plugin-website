module.exports = [
	...
	{
		desc: 'should return one issue for a document with two img tags that have different src and empty alt',
		input: '<html><body><img src="/foo.jpg" alt="" /><img src="/bar.jpg" alt="" /><body></html>',
		opts: { 'img-alt-unique': true },
		output: 1
	},
	{
		desc: 'should return zero issues for a document with two img tags that have different src and empty alt',
		input: '<html><body><img src="/foo.jpg" alt="" /><img src="/bar.jpg" alt="" /><body></html>',
		opts: { 'img-alt-unique': 'allow-empty' },
		output: 0
	},
	{
